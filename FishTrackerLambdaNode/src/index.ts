...
import { StaticMapRenderer } from './Services/StaticMapRenderer';
import { ThumbnailStorage } from './Services/ThumbnailStorage';
import { ShareEmailer } from './Services/ShareEmailer';
...
container.registerSingleton(LocationFuzzer);
container.registerSingleton(SecretsCache);
container.registerSingleton(StaticMapRenderer);
container.registerSingleton(ThumbnailStorage);
container.registerSingleton(ShareEmailer);
container.registerSingleton(CognitoUserService);
container.registerSingleton(ShareDbService);
